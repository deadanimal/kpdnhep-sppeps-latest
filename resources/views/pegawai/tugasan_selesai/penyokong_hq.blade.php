                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($permohonan as $permohonan)
                                                    <tr>
                                                        ...
                                                        <td class="align-middle text-center text-sm">
                                                            <span class="text-secondary text-sm font-weight-bold">
                                                                {{ $permohonan->catatan_penyokong }}</span>
                                                        </td>
                                                        </td>
                                                        <td class="align-middle text-center text-sm">
                                                            @if ($permohonan->status_permohonan === 'disokong_hq')
                                                                <span class="badge badge-success"> Telah Diyorkan</span>
                                                            @elseif ($permohonan->status_permohonan ===
                                                                'tidak_disokong_hq')
                                                                <span class="badge badge-danger"> Tidak Diyorkan</span>
                                                            @else
                                                                <span class="badge badge-success"> Telah Diyorkan</span>
                                                            @endif
                                                        </td>
