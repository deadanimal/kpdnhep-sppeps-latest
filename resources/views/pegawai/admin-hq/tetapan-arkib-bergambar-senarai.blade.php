                                ...
                                <form role="form text-left" method="POST" action="/tetapan-arkib-bergambar-senarai"
                                        ...
                                        <div class="col">
                                            <label class="btn bg-gradient-info form-control col-6">
                                                <i class="fa fa-image"></i> Pilih Gambar<input type="file"
                                                    style="display: none;" class="form-control" id="senaraiarkibgambar-btn1" hidden
                                                    name="gambar1">
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col">
                                            <label class="btn bg-gradient-info form-control col-6">
                                                <i class="fa fa-image"></i> Pilih Gambar<input type="file"
                                                    style="display: none;" class="form-control" id="senaraiarkibgambar-btn2" hidden
                                                    name="gambar2">
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col">
                                            <label class="btn bg-gradient-info form-control col-6">
                                                <i class="fa fa-image"></i> Pilih Gambar<input type="file"
                                                    style="display: none;" class="form-control" id="senaraiarkibgambar-btn3" hidden
                                                    name="gambar3">
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col">
                                            <label class="btn bg-gradient-info form-control col-6">
                                                <i class="fa fa-image"></i> Pilih Gambar<input type="file"
                                                    style="display: none;" class="form-control" id="senaraiarkibgambar-btn4" hidden
                                                    name="gambar4">
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col">
                                            <label class="btn bg-gradient-info form-control col-6">
                                                <i class="fa fa-image"></i> Pilih Gambar<input type="file"
                                                    style="display: none;" class="form-control" id="senaraiarkibgambar-btn5" hidden
                                                    name="gambar5">
                                            </label>
