                    ...
                    <div class="card-body p-3">
                        <div class="row p-3 mb-0">
                            ...
                            {{-- @foreach (auth()->user()->roles as $role)
                                ...
                                @endif
                            @endforeach --}}
                            <form method="POST" action="/cari_pelulus_negeri_tugasan_baru">
                                @csrf
                                <div class="row">
                                    <div class="col">
                                        <input class="form-control form-control-sm" type="number" name="no_kp" id="no_kp"
                                    ...
                                    <div class="col">
                                        ...
                                        <a href="/pelulus_negeri_tugasan_baru" class="btn btn-sm btn-danger">Set Semula</a>
                                    </div>
                                </div>
                            </form>
                        </div>
