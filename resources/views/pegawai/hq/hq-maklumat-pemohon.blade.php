...
@section('content')
    ...
    <div class="container-fluid py-4">
        ...
        <div class="p-3">
            ...
            <div class="pt-4">
                @if ($permohonan->status_permohonan === 'hantar_ke_pemproses_hq' && ($permohonan->jenis_permohonan == 'Baharu' || $permohonan->jenis_permohonan == 'Pembaharuan'))
                    <div class="card card-frame">
                        <div class="card-header" style="background-color: #f5e7f2;">
                                            ...
                                            <div class="form-group row d-flex flex-nowrap" style="width: 100%;">
                                                ...
                                                <div class="col-sm-5">
                                                    <select id="action" class="form-control" name="tindakan">
                                                        ...
                                                        <option value="hantar_ke_pdrm">Hantar
                                            ...
                                            <div class="form-group row d-flex flex-nowrap" style="width: 100%;">
                                                ...
                                                <div class="col-sm-5">
                                                    <textarea class="form-control" id="catatan"
                                                        name="catatan_pegawai_hq"></textarea>
                                                </div>
                                            </div>
                                        </div>

                                        <input type="hidden" name="jenis_tindakan" value="hantar_ke_pdrm">
                ...
                @elseif ($permohonan->status_permohonan === 'hantar_ke_pemproses_hq' && $permohonan->jenis_permohonan
                    =="Rayuan" )
                                            ...
                                            <div class="form-group row d-flex flex-nowrap" style="width: 100%;">
                                                ...
                                                <div class="col-5">
                                                    <input type="text" class="form-control col-9" id="action"
                                                        ...
                                                        value="Telah Dihantar ke Badan Agensi(PDRM)" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="d-flex flex-nowrap">
                ...
                @elseif ($permohonan->status_permohonan === 'Permohonan Lengkap' && ($permohonan->jenis_permohonan ===
                    'Rayuan' || $permohonan->jenis_permohonan === 'Pendua'))
                    <div class="card card-frame">
                                    ...
                                    <div class="p-3" fxLayout="column" fxLayoutAlign="space-evenly stretch"
                                        ...
                                        <div class="p-3 d-flex justify-content-center">
                                            <a href="/permohonan" type="button"
                                                class="btn btn-danger text-uppercase m-1">BATAL</a>
                                            <button type="button" class="btn btn-success text-uppercase m-1"
                                                data-bs-toggle="modal" data-bs-target="#modal-2">HANTAR</button>
                                            <!-- <button type="submit" class="btn btn-success text-uppercase m-1" value="HANTAR">HANTAR</button> -->
                                        </div>
                                    </div>
                                </div>
                ...
                @elseif ($permohonan->status_permohonan === 'Disokong' || $permohonan->status_permohonan === 'Tidak
                    Disokong')
