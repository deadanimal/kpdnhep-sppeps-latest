                                                ...
                                                <div class="row mt-4">
                                                    <div class="form-group pb-2 text-start">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                ...
                                                                <label class="pl-2" for="EPSworkStatus">{{ __('landing.sepenuh_masa') }}</label>
                                                                <br>
                                                                <div class="row pl-4">
                                                                    <div class="col">
                                                    ...
                                                    <div class="form-group pb-2 text-start">
                                                        <label for="education"><i
                                                                class="fas fa-graduation-cap"></i><strong>
                                                    ...
                                                    <div class="form-group text-start">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="row" id="institusi_kewangan"
                                                                @if ($permohonan->berkerja_panel_atau_syarikat == 'Tidak') style="display: none;" @endif>
                                                            ...
                                                            <div class="row" id="panel"
                                                                @if ($permohonan->berkerja_panel_atau_syarikat == 'Ya') style="display: none;" @endif>
