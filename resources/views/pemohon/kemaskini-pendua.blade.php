                                            ...
                                            <div class="multisteps-form__content">
                                                <div class="row mt-4">
                                                    <div class="form-group pb-2 pt-4 text-start">
                                                        <label for="resonTolose"><strong class=""> Alasan
                                                                Kehilangan</strong></label>
                                                            ...
                                                            <div class="col-3">
                                                                <div class="form-check">
                                                                    ...
                                                                    <label class="form-check-label"
                                                                        for="inlineCheckbox1">Kecurian</label>
                                                                </div>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                    ...
                                                                    <label class="form-check-label"
                                                                        for="inlineCheckbox1">Kebakaran</label>
                                                                </div>
                                                            </div>
                                                            <div class="col">
                                                                <div class="form-check ">
                                                                    ...
                                                                    <label class="form-check-label"
                                                                        for="inlineCheckbox1">Keciciran</label>
                                                                </div>
                                                                <div class="form-check ">
                                                                    <input class="form-check-input" type="radio"
                                                    ...
                                                    <div class="form-group pb-2 text-start">
                                                        <label for=""><strong> Permohonan Penggantian Kali
                                                                Ke</strong></label>
                                                        <!-- <input type="text" class="form-control" id="education" aria-describedby="education" placeholder=""> -->
                                                        <br>
                                                        <div class="row">
                                                            <div class="col-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        ...
                                                                        value="1" {{ $permohonan->penggantian_kali_ke == '1' ? 'checked' : '' }}>
                                                                    <label class="form-check-label"
                                                                ...
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        ...
                                                                        value="2" {{ $permohonan->penggantian_kali_ke == '2' ? 'checked' : '' }}>
                                                                    <label class="form-check-label"
                                                            ...
                                                            <div class="col-3">
                                                                <div class="form-check ">
                                                                    <input class="form-check-input" type="radio"
                                                                        ...
                                                                        value="3" {{ $permohonan->penggantian_kali_ke == '3' ? 'checked' : '' }}>
                                                                    <label class="form-check-label"
                                                                ...
                                                                <div class="form-check ">
                                                                    <input class="form-check-input" type="radio"
                                                                        ...
                                                                        value="4" {{ $permohonan->penggantian_kali_ke == '4' ? 'checked' : '' }}>
                                                                    <label class="form-check-label"
                                                            ...
                                                            <div class="col-3">
                                                                <div class="form-check ">
                                                                    <input class="form-check-input" type="radio"
                                                                        ...
                                                                        value="5" {{ $permohonan->penggantian_kali_ke == '5' ? 'checked' : '' }}>
                                                                    <label class="form-check-label"
                                                                ...
                                                                <div class="form-check ">
                                                                    <input class="form-check-input" type="radio"
                                                                        ...
                                                                        value="6" {{ $permohonan->penggantian_kali_ke == '6' ? 'checked' : '' }}>
                                                                    <label class="form-check-label"
                                                    ...
                                                    <div class="form-group col-5 pb-2 text-start">
                                                        <label for="permitCollectionState"><strong> Negeri Laporan Polis
                                                                Dibuat</strong></label>
                                                    ...
                                                    <div class="form-group text-start">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-3">
                                                                <label class="col mt-1" for="image">Salinan Repot
                                                                    Polis</label>
                                                            </div>
                                                            <div class="col">
                                                                <!-- actual upload which is hidden -->
                                                        ...
                                                        <div class="modal-dialog modal- modal-dialog-centered modal-"
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body text-center">
                                                                    <p>Permohonan pendua anda akan dihantar</p>
