                                                        ...
                                                        <div class="d-flex flex-nowrap pb-2 text-start">
                                                            <div class="col-6 form-group p-0">
                                                                ...
                                                                <select class="form-control"
                                                                    ...
                                                                    <option selected>--{{ __('landing.pilih_negeri') }}--</option>
                                                    ...
                                                    <div class="form-group text-start">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <!-- name of file chosen -->
                                                                <span id="file-chosen5" class="mt-1">{{ __('landing.tiada_fail_dipilih') }}</span>
                                                                <br>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <!-- name of file chosen -->
                                                                <span id="file-chosen6" class="mt-1">{{ __('landing.tiada_fail_dipilih') }}</span>
                                                                <br>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <!-- name of file chosen -->
                                                                <span id="file-chosen7" class="mt-1">{{ __('landing.tiada_fail_dipilih') }}</span>
                                                                <br>
