                                        ...
                                        <tbody>
                                            @foreach ($pegangpermits as $pegangpermit)
                                                <tr>
                                                    ...
                                                    <td class="text-sm font-weight-normal">{{ $pegangpermit->no_permit }}
                                                    </td>
                                                    <td class="text-sm font-weight-normal">{{ $pegangpermit->nama }}
                                                    </td>
                                                    <td class="text-sm font-weight-normal">{{ $pegangpermit->no_kp }}
                                                    </td>
                                                    <td class="text-sm font-weight-normal">{{ $pegangpermit->negeri }}
                                                    </td>
                                                    <td class="text-sm font-weight-normal">
                                                        {{ $pegangpermit->jenis_permohonan }}
                                                    </td>
                                                    <td class="text-sm font-weight-normal">{{ $pegangpermit->created_at }}
                                                    </td>
                                                    <td class="text-sm font-weight-normal">{{ $pegangpermit->updated_at }}
                                                    </td>
                                                    <td class="text-sm font-weight-normal">{{ $pegangpermit->updated_at }}
                                                    </td>
                                                </tr>
