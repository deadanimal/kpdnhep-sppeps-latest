                            ...
                            <div class="p-3" fxLayout="column" fxLayoutAlign="space-evenly stretch" style="width: 90%;">
                                ...
                                <div class="d-flex flex-nowrap">
                                    <div class="form-group row d-flex flex-nowrap" style="width: 100%;">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control form-control-sm" id="" placeholder="" value="Tiada Rekod Jenayah" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex flex-nowrap">
                                    <div class="form-group row d-flex flex-nowrap" style="width: 100%;">
                                        ...
                                        <div class="col-sm-5">
                                            <select id="action" class="form-control form-control-sm" name="tindakan" [(ngModel)]="this.tindakan">
                                                <option selected>Sila Pilih</option>
                                                <option value="support">Disokong</option>
                                                <option value="notSupport">Tidak Disokong</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex flex-nowrap">
                                    <div class="form-group row d-flex flex-nowrap" style="width: 100%;">
                                        ...
                                        <div class="col-sm-5">
                                            <select id="action" class="form-control form-control-sm" name="tempoh" [(ngModel)]="this.tempoh">
                                                <option selected>Sila Pilih</option>
                                ...
                                <div class="d-flex flex-nowrap">
                                    <div class="form-group row d-flex flex-nowrap" style="width: 100%;">
                                        ...
                                        <div class="col-sm-5">
                                            <textarea class="form-control form-control-sm" id="catatan" name="catatan" [(ngModel)]="this.catatan"></textarea>
                                        </div>
                                    </div>
                                </div>
