                    ...
                    <table class="table table-flush" id="datatable-basic">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Keterangan MS</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Keterangan EN</th>
                        ...
                        <div class="card-body">
                            <form role="form text-left">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="lokasi" name="lokasi" aria-describedby="lokasi" placeholder="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input type="date" class="form-control form-control-sm" id="tarikh" name="" aria-describedby="tarikh" placeholder="">
                                        </div>
                                        <div class="col">
                                    ...
                                    <!-- <input type="text" class="form-control form-control-sm datepicker" id="tarikh" name="tarikh" aria-describedby="tarikh" placeholder=""> -->
                                </div>
                                ...
                                <div class="text-center d-flex justify-content-end">
                                    <button type="button" class="btn btn-round bg-gradient-danger" data-bs-dismiss="modal">Batal</button>
