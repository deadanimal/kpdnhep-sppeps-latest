                    ...
                    <table class="table table-flush" id="datatable-basic">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tajuk MS</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tajuk EN</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Kandungan MS</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Kandungan EN</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tarikh Mula Papar </th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tarikh Akhir Papar </th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-sm font-weight-normal">Edinburgh</td>
                                <td class="text-sm font-weight-normal">Kandungan</td>
                                <td class="text-sm font-weight-normal">Kandungan</td>
                                <td class="text-sm font-weight-normal">12-4-2019</td>
                                <td class="text-sm font-weight-normal">12-4-2019</td>
                                <td class="text-sm font-weight-normal">12-4-2019</td>
                                <!-- <td class="text-sm font-weight-normal"> <span class="badge badge-success">Aktif</span></td> -->
                        ...
                        <div class="card-body">
                            <form role="form text-left">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="keteranganms" rows="2" name="keteranganms"></textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input type="date" class="form-control" id="title" aria-describedby="title" placeholder="" [(ngModel)]="tajuk">
                                        </div>
                                        <div class="col">
